...
def run_test_count_sines_from():
    ...
    # Test 5:
    expected = 8
    answer = count_sines_from(77, 90)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 235
    answer = count_sines_from(69, 420)
...
def count_sines_from(m, n):
    ...
    for k in range(n - m + 1):
        calc = math.sin(m + k)
        print("sine(", m+k,") is about ", calc)
        if calc < .5:
            count = count + 1
    print("count_sines_from(" , m , ", " , n ,") returns " , count)
    return count
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 3:
    expected = 421
    answer = count_sines_vs_cosines(420)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 1338
    answer = count_sines_vs_cosines(1337)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 27
    answer = count_sines_vs_cosines(27)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    # ------------------------------------------------------------------
    # TO DO: 6 (continued).
...
def count_sines_vs_cosines(m):
    ...
    for k in range((m )*2 + 1):
        sin = math.sin(-m + k)
        cos = math.cos(-m + k)
        print('sine(', k - m ,") is about ", sin, ' and cosine(', k ,") is about ", cos)
        if sin > cos:
            count = count + 1
        print("count_sines_vs_cosines(", m , ") returns ", count)
    return count
    # ------------------------------------------------------------------
