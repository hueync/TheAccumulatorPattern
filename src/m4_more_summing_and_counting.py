...
def run_test_factorial():
    ...
    # Test 3:
    answer_from_oracle = math.factorial(37)
    answer_from_my_code = factorial(37)
    ...
    # Test 5:
    answer_from_oracle = math.factorial(69)
    answer_from_my_code = factorial(69)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(6, 9, 0.420)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 13
    answer = count_cosines_from(4, 20, -0.69)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 12
    answer = count_cosines_from(13, 37, 0.125)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 16
    answer = count_cosines_from(5, 50, 0.5)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 35
    answer = count_cosines_from(11, 66, -.33)
...
def count_cosines_from(m, n, x):
    ...
    for k in range((n-m)+1):
        calc = math.cos(m + k)
        # print('cosine(', m + k,') is about ', calc)
        if calc > x:
            count = count +1
    return count
    # ------------------------------------------------------------------
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 1.814602  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(69, 420)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 1.098375  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(13, 37)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
